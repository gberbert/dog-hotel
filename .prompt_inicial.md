...
- **versão do firebase:** 12.6.0
- **versão do firebase-admin:** 12.6.0
- **versão do firebase-functions:** 12.6.0
- **versão do firebase-functions-admin:** 12.6.0
- **versão do firebase-functions-http:** 12.6.0
- **versão do firebase-functions-schedule:** 12.6.0
- **versão do firebase-functions-storage:** 12.6.0
- **versão do firebase-functions-firestore:** 12.6.0
- **versão do firebase-functions-auth:** 12.6.0
- **versão do firebase-functions-https:** 12.6.0
- **versão do firebase-functions-https:** 12.6.0
...
## 3. GESTÃO DE AMBIENTES E DEPLOY
...
## 4. MEMÓRIA PERSISTENTE (MODO RAG LOCAL)
...
## 5. REGRA TÉCNICA DE MANUTENÇÃO DE LOGS (APPEND)
